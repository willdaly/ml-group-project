"""Dataset-loading utilities for the NSL-KDD detection engine."""
...
REPO_DATASET_ROOT = Path(__file__).resolve().parents[2] / "data" / "nsl-kdd"
...
FEATURE_COLUMNS = [column for column in NSL_KDD_COLUMNS if column not in {"label", "difficulty_level"}]
